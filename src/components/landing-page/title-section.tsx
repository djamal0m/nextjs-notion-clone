  ...
  return (
    <React.Fragment>
      <section className="flex flex-col gap-4 justify-center items-start md:items-center">
        ...
        {subHeading ? (
          <>
            <h2 className="test-left text-3xl sm:text-5xl sm:max-w-[750px] md:text-center font-semibold">
              {title}
            </h2>
          ...
          <h1
            className="text-left text-4xl sm:text-6xl sm:max-w-[850px] md:text-center
            font-semibold"
          >
            {title}
          </h1>
